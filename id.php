	...
	<div class="main">
		...
		<div class="container">
		    <form > 
		        ...
		        <div class="stu_img"><input accept="image/*" type='file' id="imgInp"  />
  <img id="blah" src="#" alt="Select image" /> </div>
...
<style type="text/css">
#imgInp{width:100px;height:10px;}
    #blah{width:130px;height:150px; margin-top:-20px;margin-left:-10px;}
